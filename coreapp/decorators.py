...
def sub_admin_required(function=None, redirect_field_name=REDIRECT_FIELD_NAME, login_url='login'):
    '''
    Decorator for views that checks that the logged in user is a sub_admin,
    redirects to the log-in page if necessary.
    '''
    actual_decorator = user_passes_test(
